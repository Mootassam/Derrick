...
const en = {
  ...
  pages: {
    ...
    profile: {
      ...
      verifyPrompt: "Please verify your account to unlock all features",
      ...
      verifiedStatus: {
        verified: "Verified",
        notVerified: "Not Verified",
        verifyPrompt: "Your account is not verified. Please verify your account to access all features.",
      },
      // Financial Items
      recharge: "Deposit",
      withdraw: "Withdraw",
