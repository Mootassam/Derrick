...
/**
 * Local, bundled list of ISO 3166-1 alpha-2 country codes, names and calling
 * codes. Kept in-app (no third-party "list all countries" API call) so the
 * registration form's country selector never depends on an external service
 * being reachable — only IP-based detection (ipapi.co) needs the network.
 */
const countryCallingCodes: CountryCallingCode[] = [
